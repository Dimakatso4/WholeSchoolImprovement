...
export class CaptureSIPComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.sipService.GetSchoolKPIByEmisNumber(this.emisNumber).subscribe((res: any) => {
      this.kpiList = res;
  ...
  openViewPlanModal(content,i) {
    ...
    this.sipService.GetActionPlansByEmisNumber(this.emisNumber, this.kpiList[i].kpiid).subscribe((res: any) => {
