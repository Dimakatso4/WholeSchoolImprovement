...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (this.appservice.getLoggedInUserRole() == "PARENT") {
      ...
      this.isParentNominated = true;
      let notification: Boolean = false;

      // checks if parent is nominated and has accepted or declined
      // this.dashboardservice.getNominatedParents(this.appservice.getLoggedInEmisCode()).subscribe((parents: any) => {
      //   console.log(parents)
      ...
      //       this.dashboardservice.checkIfParentDecided(this.appservice.getLoggedInEmisCode(), this.appservice.getLoggedInParentId()).subscribe((res: any) => {

      //         if (!res || !res.hasDeclined) {
      ...
      // this.dashboardservice.getScheduledNominationByEmisCode(this.appservice.getLoggedInEmisCode(), date).subscribe((nomination: any) => {

      //   console.log(nomination)
      //   if (nomination) {

      //     if (nomination.nominationFlag == "HasStarted") {
      //       this.dashboardservice.getUserById(this.appservice.getLoggedInUserId()).subscribe((user: any) => {
