...
export class CaptureDIPActionPlanComponent implements AfterViewInit, OnDestroy, OnInit {
      ...
      if (this.validationForm.valid) {
        Swal.fire({
          ...
          console.log('kpi audit trail: '+JSON.stringify(this.selectedKpi))
            ...
            this.dipService.CreateKPIInstrumentTools(sseTool);
        ...
        Swal.fire({
          ...
          let editsseAuditTrail = 
           ...
           // console.log('kpi audit'+JSON.stringify(this.sseAuditTrail))
            ...
            //console.log("Log"+JSON.stringify(sseTool))
            this.dipService.UpdateKPIInstrumentTools(sseTool);
