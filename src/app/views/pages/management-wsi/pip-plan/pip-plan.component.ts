...
@Component({
  selector: 'app-pip-plan',
  templateUrl: './pip-plan.component.html',
  styleUrls: ['./pip-plan.component.scss']
})
export class PipPlanComponent implements AfterViewInit, OnDestroy, OnInit {
  public lessons = [];
  public kpiInfo;
  public kpiList;
  public role;
...
SubmitIntervention() {
  ...
  Swal.fire({
    title: 'Publish  DIP Action Plan?',
    text: 'Are you sure you want to Publish this DIP Action Plan ?',
    icon: 'question',
    showCancelButton: true,
    confirmButtonText: 'Yes',
    cancelButtonText: 'No'
      ...
      if (result.value) {
        ...
        let evidenceModel={
         "sipActionPlanCommentsID":this.sipActionPlanCommentsID,
          ...
          "dipCircuitComent":this.kpi.dipCircuitComent,
          "dipDirectComment":this.dipDirectComment,
...
SavePlan() {
  ...
  Swal.fire({
    title: 'Are you sure you want to Publish The  Action Plan  ',
    text: ' Action Plan   will be  Published',
    icon: 'question',
    showCancelButton: true,
    confirmButtonText: 'Yes',
